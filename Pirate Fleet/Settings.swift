...
struct Settings {
    ...
    struct Messages {
        ...
        static var HumanHitMine = "You've hit a mine! You skip a turn to recover from the shock. The computer has been rewarded an extra move on their next turn."
        static var ComputerHitMine = "The computer has hit a mine! The computer skips a turn to recover from the shock. You've been awarded an extra move on your next turn."
